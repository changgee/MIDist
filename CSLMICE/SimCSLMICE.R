...
SimCSLMICE = function(scen,R,n,M,init,iter,batch=0)
{
  K = length(n)
  method = sprintf("CSLMICE%d",K)
...
CSLMICE = function(d,M,init,iter,n)
{
  p = d$p+1
  N = sum(n)
  K = length(n)
